...
class Owner(object):
    ...
    "event handler"
    def Message(self, lockid):
        print(f"owner has been messaged about the possible theft about lockid {lockid}")
